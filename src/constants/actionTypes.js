...
//Data fetching
export const GET_ALL_STUDENTS_REQUEST = "GET_ALL_STUDENTS";
export const GET_ALL_STUDENTS_SUCCESS = "GET_ALL_STUDENTS";
export const GET_ALL_STUDENTS_FAILURE = "GET_ALL_STUDENTS";
